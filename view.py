...
criaArquivo("categoria.txt", "clientes.txt", "estoque.txt", "fornecedores.txt",
...
if __name__ == "__main__":
    while True:
        local = int(input("Digite 1 para acessar ( Categorias )\n"
                  ...
                  "Digite 7 para ver clientes que mais compraram\n"
                  "Digite 8 para ver os produtos mais vendidos\n"
                  "Digite 9 para sair\n"))
        ...
        if local == 1:
            ...
            while True:
                ...
                if decidir == 1:
                   ...
                   cat.mostrarVendas(dataInicio, dataTermino)
